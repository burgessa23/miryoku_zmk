...
&kp LSHFT        K20  K21  K22  K23  K24  U_HML(RCMD, LG(PIPE))              U_RAYCAST(LS(LG(SPACE)), LS(LG(A)))  K25  K26           K27  K28  K29  &kp RSHFT  \
&kp LG(F6)  &kp LS(LG(A))     &kp LS(LA(C))  &kp F11   K32  K33                    K34     K35  K36                K37  &kp F12  &kp LG(LBKT) &kp LGUI &kp LG(RBKT) \
