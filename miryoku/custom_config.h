...
XXX  K20  K21  K22  K23  K24  U_HML(RCMD, LG(PIPE))              U_RAY(LS(LA(C)), LS(LG(SPACE)))  K25  K26           K27  K28  K29  XXX  \
XXX  &kp LS(LG(A))     &kp LS(LA(C))  U_HML(LSHFT, F11)   K32  K33                    K34     K35  K36                K37  U_HMR(RSHFT, F12)  &kp LG(LBKT) &kp LG(RBKT) XXX  \
