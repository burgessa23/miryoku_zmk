...
U_LT(U_BUTTON, ESC)    K00  K01  K02  K03  K04                                                                                  K05               K06  K07  K08  K09  U_LT(U_BUTTON, BSPC)     \
U_SHFT_CAPS(LSHFT)  K10  K11  K12  K13  K14                                                                                  K15               K16  K17  K18  K19  U_SHFT_CAPS(RSHFT)    \
U_MT(LCTRL, LS(LG(A)))     K20  K21  K22  K23  K24             U_HML(LS(LA(C)), ESC)                 U_HMR(LA(TAB), LS(LG(SPACE)))  K25               K26  K27  K28  K29  U_BAK_FWD_PIPE  \
