...
U_SHFT_CAPS(LSHFT)  K10  K11  K12  K13  K14                                                                                  K15               K16  K17  K18  K19  U_SHFT_NUM(LCTRL)    \
U_MT(LCTRL, LS(LG(A)))     K20  K21  K22  K23  K24             U_HML(LALT, LS(LA(C)))                 U_HMR(LA(TAB), LS(LG(SPACE)))  K25               K26  K27  K28  K29  U_BF_WRAP(LCMD, ESC)  \
