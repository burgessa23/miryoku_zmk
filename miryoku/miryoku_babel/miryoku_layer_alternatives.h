...
AS(Q),          ASN_W,         ASN_E,                ASN_R,                U_T_T,              ASN_Y,             AS(U),                 AS(I),                U_O_O,         U_P_P,             \
HRA(LGUI, A),   HRS(LALT, S),  HRD(LCTL, D),         AS(F),                AS(G),              U_H_H,             AS(J),                 HRK(LCTL, K),         HRL(LALT, L),  HRSQT(LGUI, SQT),  \
AS(Z),          ASN_X,         ASN_C,                ASN_V,                AS(B),              U_N_N,             AS(M),                 AS(COMMA),            AS(DOT),       AS(SLASH),         \
