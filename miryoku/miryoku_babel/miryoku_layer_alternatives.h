...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_NP,              &kp F15,         &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG         \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_NP,              &kp F14,         &kp C_VOL_DN,      &kp C_PREV,        U_NP,            \
