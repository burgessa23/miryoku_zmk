...
AS(Q),          ASN_W,         ASN_E,                ASN_R,                U_MT(LC(T), T),     ASN_Y,             AS(U),                 AS(I),                U_MT(LC(O), O), U_MT(LC(P), P),    \
HRA(LGUI, A),   HRS(LALT, S),  HRD(LCTL, D),         AS(F),                AS(G),              U_MT(LC(H), H),    AS(J),                 HRK(LCTL, K),         HRL(LALT, L),   HRSQT(LGUI, SQT),  \
AS(Z),          ASN_X,         ASN_C,                ASN_V,                AS(B),              U_MT(LC(N), N),    AS(M),                 AS(COMMA),            AS(DOT),        AS(SLASH),         \
...
#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT \
U_BOOT,            &u_to_U_SYM,       &u_to_U_NUM,       &u_to_U_BASE,      U_NA,              U_NU,              U_WH_L,            U_MS_U,            U_WH_R,            U_WH_U,            \
&kp LGUI,          &kp LC(S),         &kp LC(N),         &kp LC(H),         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,            \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_NA,              &kp F15,         &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,         \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_NA,              &kp F14,         &kp C_VOL_DN,      &kp C_PREV,        U_NA,            \
...
&kp F11,           &kp F7,            &kp F8,            &kp F9,            &kp F23,        &kp F24,          U_CUT,         U_CPY,          U_PST,        U_RDO,            \
&kp F12,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,       &kp LNLCK,        &kp LSHFT,     &kp LCTRL,      &kp LALT,     &kp LGUI,         \
