...
U_NP,              U_NP,           U_LT(U_MEDIA, ESC), U_NST(U_NAV, SPACE),  U_LT(U_MOUSE, TAB), U_LT(U_SYM, BSPC), U_LT(U_NUM, RET), U_LT(U_FUN, DEL), U_NP,              U_NP
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp CAPSLOCK,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
